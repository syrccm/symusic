...
const INTRO_SECTIONS: { title: string; body: ReactNode }[] = [
  {
    ...
    body: (
      <>
        ...
        <p>
          <B>1643년</B>, 잉글랜드 의회는 교회를 성경에 따라 바르게 개혁하기 위해
          학식 있는 신학자들을 이곳 웨스트민스터 사원에 불러 모아 총회를
          열었습니다. 회의가 열린 장소의 이름을 따라 이 모임을{' '}
          <B>‘웨스트민스터 총회’</B>라 부르게 되었습니다.
        </p>
        <p>
    ...
    body: (
      <>
        <p>
          ...
          여전히 로마 가톨릭의 전통을 그대로 두어 <B>개혁이 불완전</B>했습니다.
          당시 잉글랜드 교회는 “눈을 감으면 신교, 귀를 막으면 로마 가톨릭”이라는
          평을 들을 정도였습니다.
        </p>
        <p>
          이에 더 철저한 성경적 개혁을 요구하는 <B>청교도(Puritan) 운동</B>이
          일어났습니다. 한편 스코틀랜드에서는 <B>존 녹스</B>가 제네바에서 칼뱅의
          지도를 받고 돌아와(1560년) 장로회 제도를 세우고 <B>완전한 종교개혁</B>을
          이루었습니다.
        </p>
        <p>
          그러나 <B>찰스 1세</B>는 교회에 제단과 미사 예식, 주교 제도를 다시
          들여오며 가톨릭화를 밀어붙였고, 이는 청교도와 장로교도는 물론 일반
          국민의 분노를 샀습니다. 왕과 의회의 갈등은 마침내{' '}
          <B>청교도 혁명(내전)</B>으로 이어졌습니다.
        </p>
        <p>
          1638년 스코틀랜드는 <B>국민언약</B>을 맺었고, 1643년에는 잉글랜드
          의회파와 <B>‘엄숙동맹과 언약’</B>을 체결했습니다. 바로 이 언약을 통해
          교회 개혁을 위한 <B>웨스트민스터 총회</B>가 소집되었습니다.
        </p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <p>
          웨스트민스터 총회는 <B>약 5년간(1643~1649년)</B> 무려{' '}
          <B>1,163차례</B>의 회의를 거쳤습니다. 기도와 예배, 금식이 함께한 경건의
          훈련 과정이기도 했습니다.
        </p>
        <p>
          이 자리에는 <B>121명의 학식 있는 신학자와 목사, 그리고 의원</B>들이
          참여했고, 스코틀랜드 장로교회의 대표들도 함께했습니다.
        </p>
        <p>총회는 네 가지 표준문서를 작성했습니다.</p>
        <ul className="ml-1 list-inside list-disc space-y-1 text-white/90">
          <li><B>신앙고백서</B></li>
          <li><B>대·소요리문답</B></li>
          <li><B>예배모범</B></li>
          <li><B>장로회 정치</B></li>
    ...
    body: (
      <>
        <p>
          ...
          기독교 역사상 <B>가장 명확하고 정교한 신앙고백서</B> 중 하나로 꼽힙니다.
        </p>
        <p>
          1660년 왕정복고 이후 잉글랜드는 이 문서를 폐기했지만, <B>스코틀랜드
          교회가 계속 받아들여</B> 전 세계 장로교·개혁교회로 퍼져 나갔습니다.
        </p>
        <p>
          오늘날 이 문서는 <B>전 세계 장로교·개혁교회의 신앙 표준</B>이며,{' '}
          <B>한국 장로교 모든 교단의 신조</B>이기도 합니다.
        </p>
      </>
    ),
  },
    ...
    body: (
      <>
        ...
        <p>
          ...
          <B>신앙의 고백</B>이 되도록 돕습니다.
        </p>
        <p>
          바라기는 이 고백이 머릿속 지식에 머무르지 않고,{' '}
          <B>우리의 삶 속에 녹아드는 실제 고백</B>이 되기를 소망합니다.
        </p>
      </>
    ),
  },
        ...
        {INTRO_SECTIONS.map((s, i) => {
          ...
          return (
            ...
            >
              ...
              >
                <div className="overflow-hidden">
                  <div className="space-y-2 border-t border-purple-400/15 px-4 py-3.5 text-sm leading-relaxed text-white/90">
                    {s.body}
                  </div>
                </div>
              </div>
